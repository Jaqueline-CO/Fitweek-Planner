export const weeklyPlans = [
  {
    id: "jaqueline",
    name: "Plan Jaqueline",
    description: "Distribución semanal de 5 días con enfoque en glúteo, isquios y pierna, frecuencia 3,1,1.",
    days: [
  ...
  },
  {
    id: "israel",
    name: "Plan Alan",
    description: "Distribución semanal de 5 días con enfoque en Pecho, frecuencia 2,2,1.",
    days: [
      { day: "Lunes", routineId: "gluteo-isquios", label: "Glúteo e isquios" },
      { day: "Martes", routineId: "pecho-a", label: "Pecho" },
